		...
		<nav class="site-navbar" :class="{ 'site-navbar--fold': sidebar.sidebarFold }">
			<div class="site-navbar__header">
				<h1 class="site-navbar__brand">
					<a class="site-navbar__brand-lg">耀东大健康体检系统</a>
		...
		<aside class="site-sidebar site-sidebar--dark">
			<div class="site-sidebar__inner">
				<el-menu :default-active="siteContent.menuActiveName || 'Home'" :collapse="sidebar.sidebarFold"
					...
					<el-sub-menu index="组织管理" :popper-class="
            ...
            ">
					...
					<el-sub-menu index="业务管理" :popper-class="
              'site-sidebar--' + sidebar.sidebarLayoutSkin + '-popper'
            ">
						<template #title>
					...
					<el-sub-menu index="体检管理" :popper-class="
              'site-sidebar--' + sidebar.sidebarLayoutSkin + '-popper'
            ">
						<template #title>
					...
					<el-sub-menu index="系统设置" :popper-class="
              'site-sidebar--' + sidebar.sidebarLayoutSkin + '-popper'
...
<script setup lang="ts">
	...
	function selectedTabHandle(tab) {
		router.push({//通过路由来切换页面
			name: tab.paneName
		});
	}

	function removeTabHandle(tabName) {
		//让mainTabs数组删除要关闭的Tab
		...
		if (siteContent.mainTabs.length >= 1) {
			...
			siteContent.mainTabsActionName = '';

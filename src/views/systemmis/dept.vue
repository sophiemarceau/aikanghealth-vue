<template>
	<div v-if="proxy.isAuth(['ROOT', 'DEPT:SELECT'])">
		<el-form :inline="true" :model="dataForm" :rules="dataRule" ref="form">
			<el-form-item prop="deptName">
				<el-input v-model="dataForm.deptName" placeholder="部门名称" maxlength="10" class="input"
					clearable="clearable">
				</el-input>
			</el-form-item>
			...
			<el-form-item prop="deptName">
				...
				<el-button type="danger" :disabled="!proxy.isAuth(['ROOT', 'DEPT:DELETE'])"
		...
		<el-table :data="data.dataList" :header-cell-style="{ 'background': '#f5f7fa'}" border v-loading="data.loading"
			...
			<el-table-column prop="deptName" header-align="center" align="center" label="部门名称" min-width="170"
				fixed></el-table-column>
			<el-table-column prop="tel" header-align="center" align="center" label="联系电话" width="170"></el-table-column>
			<el-table-column prop="email" header-align="center" align="center" label="邮箱" width="270"></el-table-column>
			<el-table-column header-align="center" align="center" label="员工数量" width="140">
				<template #default="scope">
			...
			<el-table-column fixed="right" header-align="center" align="center" label="操作" width="150">
				<template #default="scope">
					<el-button type="text" :disabled="!proxy.isAuth(['ROOT', 'DEPT:UPDATE'])"
	...
	<el-dialog :title="!dialog.dataForm.id ? '新增' : '修改'" v-if="proxy.isAuth(['ROOT', 'DEPT:INSERT', 'DEPT:UPDATE'])"
		...
		<el-form :model="dialog.dataForm" ref="dialogForm" :rules="dialog.dataRule" label-width="60px">
			...
			<el-form-item label="电话" progress="tel">
				<el-input v-model="dialog.dataForm.tel" maxlength="11" clearable></el-input>
			</el-form-item>
			<el-form-item label="邮箱" prop="email">
				<el-input v-model="dialog.dataForm.email" maxlength="200" clearable></el-input>
			</el-form-item>
			<el-form-item label="备注" prop="desc">
				<el-input v-model="dialog.dataForm.desc" maxlength="20" clearable></el-input>
			</el-form-item>
	...
	function dataFormSubmit() {
		proxy.$refs['dialogForm'].validate(valid => {
			if (valid) {
				...
				proxy.$http(`/mis/dept/${dialog.dataForm.id == null ? 'insert' : 'update'}`, 'POST', dialog.dataForm, true, function (resp) {
					if (resp.rows == 1) {
						proxy.$message({
							message: '操作成功',
							type: 'success',

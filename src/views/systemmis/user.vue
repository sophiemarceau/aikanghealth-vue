<template>
		...
		<el-form :inline="true" :model="dataForm" :rules="dataRule" ref="form">
			...
			<el-form-item>
				<el-select v-model="dataForm.role" class="input" placeholder="角色" clearable="clearable">
					<el-option v-for="one in dataForm.roleList" :label="one.roleName" :value="one.roleName"></el-option>
				</el-select>
			</el-form-item>
			<el-form-item>
	...
	<el-dialog :title="!dialog.dataForm.id ? '新增' : '修改'" v-if="proxy.isAuth(['ROOT', 'USER:INSERT', 'USER:UPDATE'])"
		...
		<el-form :model="dialog.dataForm" ref="dialogForm" :rules="dialog.dataRule" label-width="80px">
			...
			<el-form-item label="密码" prop="password" v-if="!dialog.update">
				<el-input type="password" v-model="dialog.dataForm.password" maxlength="20" clearable></el-input>
			</el-form-item>
			<el-form-item label="姓名" prop="name">
				<el-input v-model="dialog.dataForm.name" maxlength="10" clearable></el-input>
			</el-form-item>
			...
			<el-form-item label="入职日期" prop="hiredate">
				<el-date-picker v-model="dialog.dataForm.hiredate" type="date" placeholder="选择日期" :editable="false"
